...
/**
 * Jersey REST client generated for REST resource:SancionFacadeREST
 * [entity.sancion]<br>
 * USAGE:
 * <pre>
 *        SancionClient client = new SancionClient();
...
public class SancionClient {
    ...
    public SancionClient() {
        ...
        webTarget = client.target(BASE_URI).path("entity.sancion");
    }
